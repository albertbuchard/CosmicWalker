...
window.loadingPromise.then(function () {
  ...
  };var parametersNames = ['parameters.explosionTime', 'parameters.minSize', 'parameters.maxSize', 'parameters.minLifeTime', 'parameters.maxLifeTime', 'parameters.emitRate', 'parameters.minEmitPower', 'parameters.maxEmitPower', 'parameters.shouldRandomize'];
...
var nextTrial = function nextTrial() {
  ...
  if (trialIndex >= trials.length) {
    // || (Math.floor(trialIndex / parameters.trialsBeforePause) > pausesDone.length)) {
    this.stateManager.set('pausesDone', pausesDone.push(pausesDone.length));
