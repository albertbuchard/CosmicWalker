...
window.p2 = R.addFiles(window.assetsFolderFullpath + '/assets/yaml/ressources.yaml', window.assetsFolderFullpath + '/assets/json/randomized_trials_final_pure_impure.json');
