...
exports.explode = exports.hideCross = exports.showCross = exports.setViewForDirection = exports.hidePointSpheres = exports.showPointSpheres = exports.updatePoints = exports.placePoints = exports.checkIdleAndConnection = exports.setBlackScreen = exports.setMargins = exports.highlightPosition = exports.addButton = undefined;
...
window.p2 = R.addFiles(window.assetsFolderFullpath + '/assets/yaml/ressources.yaml', window.assetsFolderFullpath + '/assets/json/trials_full.json');
...
window.loadingPromise.then(function () {
  ...
  };var parametersNames = ['parameters.explosionTime', 'parameters.minSize', 'parameters.maxSize', 'parameters.minLifeTime', 'parameters.maxLifeTime', 'parameters.emitRate', 'parameters.minEmitPower', 'parameters.maxEmitPower'];
...
function MainScene() {
  ...
  var cwDataFields = ['subject_id', 'level', 'block', 'block_type', 'dominant_structure', 'dominant_transition_probability', 'trial', 'trial_type', 'position', 'observation_duration', 'subject_choice', // NA for NOGO
  'correct', 'response_time', // NA for NOGO or no response
  'key_hits', // ['key', 'time'], [k,t], ...
  'clicks', 'has_paused', 'start_observation', 'responded_at'];
...
var pauseTransition = function pauseTransition() {
  ...
  try {
    ...
    var maxTransitionTime = R.get.pameters.pauseTime;
    ...
    var transitionText = function transitionText() {
      ...
      return R.get.finishedLevelTransition.replace('{n}', (0, _experimentJs.String)(timeLeft));
    };
...
var nextTrial = function nextTrial() {
  ...
  // explode spheres
  if ((0, _experimentJs.hasConstructor)(Object, this.state.currentTrialData) && this.state.currentTrialData.direction === this.state.currentTrialData.choice) {
  ...
  var trialIndex = _lodash2.default.random(0, trials.length - 1);
  this.stateManager.set('currentTrial', trialIndex);
  var trialData = trials[trialIndex]; // TODO Change that
  ...
  (0, _experimentJs.delay)(parameters.explosionTime).then(function () {
  ...
  try {
    ...
    if (direction !== null) {
      ...
      if (state.isPredicting === true && state.currentTrialData.choice === null) {
        ...
        stateManager.call('highlightPosition', { direction: direction });
